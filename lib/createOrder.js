...
function createOrder (options) {
  ...
  return _private.makeRequest(_getOrderOptions(options),
 ...
 * @private
 */
function _getOrderOptions (options) {
  return {
    method: 'POST',
    ...
    formData: {
      ...
      tone: options.tone,
      is_including_not_translated: JSON.stringify(options.includeNotTranslated),
      is_including_not_approved: JSON.stringify(options.includeNotApproved),
      is_including_outdated: JSON.stringify(options.includeOutdated),
